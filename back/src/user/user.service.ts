    ...
    constructor(@InjectRepository(User)
      ...
      public async InsertUser( userDto : UserDto)
      {
        ...
        return await this.usersRepository.query(`select * from Users`);
          ...
          public async findUser(request: ExampleDto)
          {
          ...
          // var get = await getConnection().createQueryBuilder().select().from(User,"us").where("'userName' = :id ", { id: request.userName }).getOne();
